...
const teamMembers = [
  { name: "Kevin X. Smith", title: "CFA", role: "Partner", initials: "KS" },
  { name: "Derek Ripp", title: "CFP®, CEPA", role: "Partner", initials: "DR" },
  { name: "Julie Hayes", title: "MA", role: "Senior Advisor", initials: "JH" },
  { name: "Anna Bell Gall", title: "MPP", role: "Financial Planner", initials: "AG" },
  { name: "John Toungate", title: "CFP®", role: "Financial Planner", initials: "JT" },
  { name: "Shane McDougald", title: "CFP®", role: "Financial Planner", initials: "SM" },
  { name: "Sheila Schmitt", title: "", role: "Operations", initials: "SS" },
  { name: "Manisha Gupta", title: "CFP®, MBA", role: "Financial Planner", initials: "MG" },
  { name: "Matthew Pierce", title: "CFA", role: "Investment Analyst", initials: "MP" },
  { name: "Parker Manson", title: "MBA", role: "Associate Advisor", initials: "PM" },
  { name: "David Lowe", title: "CFP®", role: "Financial Planner", initials: "DL" },
  { name: "Nikki Yates", title: "CFP®", role: "Financial Planner", initials: "NY" }
];
            ...
            {teamMembers.map((member, index) => (
              <AnimatedSection key={member.name} delay={index * 0.05}>
                <div className="group text-center">
                  <div className="relative aspect-square rounded-2xl bg-gradient-to-br from-slate-100 to-slate-200 overflow-hidden mb-4 transition-all duration-300 group-hover:shadow-lg">
                    <div className="absolute inset-0 flex items-center justify-center">
                      <span className="text-4xl font-light text-slate-400 group-hover:scale-110 transition-transform duration-300">
                        {member.initials}
                      </span>
                    </div>
                  ...
                  {member.title && (
                    <p className="text-amber-600 text-sm mt-0.5">{member.title}</p>
                  )}
                </div>
              </AnimatedSection>
            ))}
